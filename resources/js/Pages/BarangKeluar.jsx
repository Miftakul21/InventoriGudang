...
const BarangKeluar = () => {
    ...
    const handleFilter = (e) => {
        const datas = barangKeluar.filter((item) => {
    ...
    const columnsRole = auth.user.role != "admin" ? columnsAdmin : columnsSales;
    ...
    const confirmDelete = (kd_barang) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(`/barang-keluar/${kd_barang}`);
                Swal.fire({
                    title: "Hapus!",
    ...
    return (
        <Template>
            <Head title="InventoriApp - Barang Keluar" />
            {/* Page Heading  */}
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">Barang Keluar</h1>
            </div>
            <div className="row">
